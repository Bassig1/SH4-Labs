...
void testSLLSetIntArrayuser() {

        int arr[] = {1, 2, 3, 7, 9}; // this list

        SLLSet listObj2 = SLLSet(arr,5);
        string expectedSet = "1, 2, 3, 7, 9";
        int expectedSize = 5;
        ASSERT_EQUAL(expectedSize,listObj2.getSize());
        ASSERT_EQUAL(expectedSet,listObj2.toString());
	}
...
void testCopyuser() {
        ...
        int arr[] = {5, 2, 3, 7, 8}; // this list
        SLLSet listObj2 =  SLLSet(arr,5);
		SLLSet copied = listObj2.copy();
        copied.add(100);
        string expectedObj2 = "5, 2, 3, 7, 8";
        string expectedCopied = "5, 2, 3, 7, 8, 100";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 6;
...
void testIsInFalseuser() {

    int arr[] = {1, 2, 3, 7, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);


        int notin = 14; // test isIn
        bool expected = false;
...
void testAdd3user() {
    ...
    SLLSet listObj2 =  SLLSet(arr,5);
        ...
        string expectedObj2 = "1, 2, 3, 7, 8, 10";
        int expectedObj2Size = 6;
...
void testUnion2user() {
    ...
    int arr[] = {1, 2, 3, 7, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
    int uni1[] = {0, 2, 3, 8, 11, 20};


        SLLSet listObj5 = SLLSet(uni1,6);
        SLLSet listObj6 = listObj2.setUnion(listObj5);

        string expected = "0, 1, 2, 3, 7, 8, 11, 20";
        int expectedSize = 8;
...
void testIntersection2user() {

    int arr[] = {1, 2, 4, 5, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);

    int arr2[] = {0,2,4}; // this list
    SLLSet listObj11 =  SLLSet(arr2,3);
...
void testDifference3user() {

	      // parameters inpt here

    int arr[] = {1, 2, 3, 8, 9}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);
...
bool runAllTests(int argc, char const *argv[]) {
    ...
    s.push_back(CUTE(testSLLSetIntArrayuser));
    s.push_back(CUTE(testCopyuser));
    s.push_back(CUTE(testIsInFalseuser));
    s.push_back(CUTE(testAdd3user));
    s.push_back(CUTE(testRemove1user));
    s.push_back(CUTE(testUnion2user));
    s.push_back(CUTE(testIntersection2user));
    s.push_back(CUTE(testDifference3user));
    s.push_back(CUTE(testUnionSLLSetArrayuser));
