...
//=========Question 1==================================
	...
	void TestQ1_two_stringsuser(CuTest *tc) {

		CuAssertStrEquals(tc, "HelloTesting!", my_strcat("Hello","Testing!"));
	}

	void TestQ1_first_emptyuser(CuTest *tc) {

			CuAssertStrEquals(tc, "Waffles", my_strcat("","Waffles"));
		}
	void TestQ1_second_emptyuser(CuTest *tc) {

			CuAssertStrEquals(tc, "Cat", my_strcat("Cat",""));
	}
//===========================================================
//=================Question 2================================
	...
	void TestQ2_find_notThereuser(CuTest *tc) {
			...
			int expected = -1;
			int actual = find(0071,Clist,size);
	...
	void TestQ2_find_Thereuser(CuTest *tc) {
	...
	void Q2UserGrades(CuTest *tc) {



			char inputFile[] =  "studentsuser.txt";
			char gradesFile[] =  "gradesuser.txt";
			int size;
			//create list using the input file
			student **Clist = create_class_list(inputFile,&size);
			//input grades using the grades input file
			...
			compute_final_course_grades(Clist,size);
			//Output final course marks
			output_final_course_grades("outputGradesuser.txt",Clist,size);

			//now we open the golden file with the written file and compare line by line

			char actualFile[] =  "outputGradesuser.txt";
			char goldenFile[] =  "outputuser.txt";
		...
		withdraw(1000,Clist,&size);
		withdraw(1400,Clist,&size);
		withdraw(9001,Clist,&size);
		}
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ1_two_stringsuser);
		SUITE_ADD_TEST(suite, TestQ1_first_emptyuser);
		SUITE_ADD_TEST(suite, TestQ1_second_emptyuser);
		...
		SUITE_ADD_TEST(suite, TestQ2_find_notThereuser);
		SUITE_ADD_TEST(suite, TestQ2_find_Thereuser);
		SUITE_ADD_TEST(suite, Q2UserGrades);
